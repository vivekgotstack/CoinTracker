...
const InstallPrompt = () => {
  ...
  return (
    <div className="fixed inset-x-3 bottom-24 z-40 mx-auto max-w-md rounded-3xl border border-(--border) bg-[color-mix(in_srgb,var(--surface)_94%,transparent)] p-4 shadow-2xl backdrop-blur-xl sm:bottom-6">
      <div className="flex items-start gap-3">
        <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-(--primary) text-white">
          <Download size={20} />
        </div>
        <div className="min-w-0 flex-1">
          <h3 className="font-bold text-(--foreground)">Install CoinTracker</h3>
